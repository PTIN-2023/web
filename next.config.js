...
module.exports = {
  ...
  async redirects() {
    ...
    const patientRoutes = ['/patients', '/notifications', '/map_global', '/map_local', '/inventory_global', '/inventory_local', '/orders', '/stats', '/prescriptions'];
    const doctorRoutes = ['/myorders', '/makeorder', '/map_global', '/map_local', '/inventory_global', '/inventory_local', '/orders', '/stats'];
    const managerRoutes = ['/myorders', '/makeorder', '/patients', '/notifications', '/prescriptions'];
    const unloggedRoutes = ['/myorders', '/makeorder', '/map_global', '/map_local', '/inventory_global', '/inventory_local', '/orders', '/stats', '/patients', '/notifications', '/profile', '/prescriptions'];
