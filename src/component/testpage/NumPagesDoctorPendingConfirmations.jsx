...
export default function NumPagesDoctorPendingConfirmations({apiEndpoint}) {
  // Cookies
  ...
  const [sumbitAndFetch, stringResponse] = useSumbitAndFetch(
    stringRequest,
    apiEndpoint+"/api/num_pages_doctor_pending_confirmations"
  )
  
  // Define the HTML/React code
  return(
    <TestPageTabLayout 
      title="Num pages doctor pending confirmations API test" 
