...
export default function NumPagesMedicinesTestComponent({apiEndpoint}) {
  // Cookies
  ...
  const [sumbitAndFetch, stringResponse] = useSumbitAndFetch(
    stringRequest,
    apiEndpoint+"/api/num_pages_available_medicines"
  )

  // Define the HTML/React code
  return(
  <TestPageTabLayout 
      title="Num pages available medicines API test" 
