...
export async function getStaticProps() {
  //función de nextjs que se encarga de cargar los datos inventario.json (placeholder que después se cambiará por la API)
  const filePath = path.join('public/', 'inventario.json');
...
export default function Home(props) {
 //recibe props: inventario
 //searchValue es un estado que guarda el texto de busqueda del componente MyOrdersSearch
 //se declara aqui arriba para pasarlo a los hijos, actualizar el State y pasarlo a TablaInventario
    ...
    <>
      ...
      <main>
        ...
        <div className={myordersStyles.mainContainer}>
          {/**TablaInventario recibe cuantas filas va a renderizar, los datos y el valor para filtrar en caso d eque haya */}
          <TablaInventario data={inventario} rowsPerPage={10} searchValue={searchValue} setSearchValue={setSearchValue}/>
        </div>
        </Layout> 
      </main>
    </>
